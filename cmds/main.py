...
class Main(Cog_Extension):
	...
	async def info(self, ctx):
		...
		embed.add_field(name="開發者 Developers", value="Casper Ong#9398", inline=False)
		embed.add_field(name="源碼 Source", value="[Link](https://github.com/CasperOng/Visual/)", inline=True)
		embed.add_field(name="協助 Support Server", value="[Link](https://discord.gg/ah3FhBZ8v4)" , inline=True)
